...
package body Pp.Formatting is
   ...
   function Good_Column
     (PP_Indentation : Positive; Indentation : Natural) return Natural
   is ((Indentation / PP_Indentation) * PP_Indentation);
   ...
   is (Libadalang.Analysis.Short_Image (Tree));
   ...
   begin
      return
        Kind (Tok) in Ident | String_Lit
        or else (Kind (Tok) in Reserved_Word_2012
   ...
   is
      ...
      Leading_Blanks : constant Natural :=
        (if Arg (Cmd, Comments_Gnat_Beginning)
           and Kind (Comment_Tok) = Fillable_Comment
   ...
   is
      ...
      pragma
        Assert
          (if Kind (Comment_Tok) in Whole_Line_Comment
      ...
      pragma
        Assert
          (if Kind (Comment_Tok) in Whole_Line_Comment
             then Indentation'Length = Sloc_Col (Comment_Tok) - 1);
         ...
         begin
            ...
            then
               ...
               then
                  pragma
                    Assert
                      (Kind (Last (New_Tokns'Access)) not in
                         Disabled_LB_Token);
                  ...
                  begin
                     ...
                     for Line of Paragraph_Tabs loop
                        ...
                        begin
                           ...
                           pragma
                             Assert (if Tab.Is_Fake then Tab.Num_Blanks = 0);
                           ...
                           pragma
                             Assert (if Num_Lines = 1 then Tab.Num_Blanks = 0);
